...
from agent_funcs import drought_risk_percentage, land_degradation_risk_percentage, chatbot_query, risk_summary, generate_soil_data_predictions, predict_land_percentage, predict_drought_percentage, generate_summary_prediction, get_migration_patterns, get_area_type, get_graduation_rate
...
async def query_handler(ctx: Context, sender: str, message: Response):
    ...
    try:
        ...
        await ctx.send(PREDICTOR_AGENT_ADDRESS, Response(text="Success", data=economist_data))
