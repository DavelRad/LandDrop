...
def get_poverty_from_coords(lat: float, lon: float):
    try:
        ...
        messages = [
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "You are an AI assistant that helps the user find the poverty count based off a city, state, and country. The user will input the city, state, and country. Only send back the poverty count as a number and nothing else."
                    }
                ]
            },
            {
