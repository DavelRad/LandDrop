    ...
    <Card className="w-96 h-full overflow-hidden rounded-r-xl border-black shadow-xl ">
      <CardHeader className="bg-gradient-to-r from-[#4FC3F7] to-[#1E88E5] text-white">
        ...
        <CardDescription className="text-gray-100">
          {`Lat: ${theLocation.lat.toFixed(4)}, Lon: ${theLocation.lon.toFixed(
            4
          )}`}
        </CardDescription>

        <Select onValueChange={(v) => {if (v == 'true') { setTimeState(true) } else { setTimeState(false) }}}>
          ...
          <SelectContent>
            <SelectGroup>
              ...
              <SelectItem value="true">Future</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
      </CardHeader>
        ...
        <Tabs defaultValue="details" className="w-full">
              ...
              <div className="p-6 space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <Select onValueChange={(v) => setDateState(v)}>
                    <SelectTrigger className="w-[180px]">
                      <SelectValue
                        placeholder={dates ? dates[0] : "Choose a date"}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectGroup>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Card className="p-4 flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {soilData.bulk_soil_density} kg/m³
                      </p>
                    </div>
                  </Card>
                  <Card className="p-4 flex items-center space-x-2">
                  ...
                  <Card className="p-4 flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {soilData.evapotranspiration} mm
                      </p>
                    </div>
                  </Card>
                  <Card className="p-4 flex items-center space-x-2">
                  ...
                  <ResponsiveContainer width="100%" height={200}>
                    <LineChart
                      data={[
                        ...
                        {
                          depth: "10-40cm",
                          moisture: soilData.v_soilm_10_40cm,
                        },
                        {
                          depth: "40-100cm",
                          moisture: soilData.v_soilm_40_100cm,
                        },
                        {
                          depth: "100-200cm",
                          moisture: soilData.v_soilm_100_200cm,
                        },
                      ]}
                    >
            ...
            <ScrollArea className="h-[calc(100vh-200px)]">
              <div className="p-6 space-y-6">
                ...
                <ResponsiveContainer height={200}>
                  <LineChart
                    data={
                      Array.isArray(soilDataArray) &&
                      Array.isArray(landDegradation)
                        ? soilDataArray.map((entry, index) => ({
                            date: entry.valid_date, // x-axis value from soilDataArray's valid_date
                ...
                <ResponsiveContainer height={200}>
                  <LineChart
                    data={
                      Array.isArray(droughtData) &&
                      Array.isArray(landDegradation)
                        ? droughtData.map((drought, index) => ({
                            drought: drought, // Assuming `drought` contains date information for x-axis consistency
          ...
          <TabsContent value="social">
            <ScrollArea className="h-[calc(100vh-200px)]">
              <div className="p-6">
                { details &&  <>
                    <h3 className="text-xl font-semibold">Socioeconomic Details</h3>
                    <h4><strong>Location:</strong></h4>
                    <span>{details.location}</span>
                    <h4><strong>Vegetation Level:</strong></h4>
                    <span>{details.vegetation_level}</span>
                    <h4><strong>Average Salary:</strong></h4>
                    <span>{details.average_salary}</span>
                    <h4><strong>Food Price Percentage:</strong></h4>
                    <span>{details.food_price_percentage}</span>
                    <h4><strong>Economic Diversity:</strong></h4>
                    <span>{details.economic_diversity}</span>
                    <h4><strong>Graduation Rate:</strong></h4>
                    <span>{details.graduation_rate}</span>
                </>
                }
